import{R as t,j as e}from"./index-DLsh4aVm.js";import{S as r}from"./sharer-D66QtLcw.js";import{P as s}from"./prism-aeLWygXh.js";class d extends t.Component{componentDidMount(){window.scrollTo(0,0),document.title="Quirks of JavaScript - The Language of the Web | blog by Pranshu Gupta",s.highlightAll()}render(){return e.jsxs("div",{className:"language-javascript",children:[e.jsx("div",{className:"row bhead",children:e.jsx("i",{className:"fab fa-js-square bigger gt1"})}),e.jsxs("h1",{className:"title",children:["Quirks of JavaScript - ",e.jsx("br",{}),"The Language of the Web"]}),e.jsx("p",{children:"Pranshu Gupta, June 5, 2017"}),e.jsx(r,{link:window.location.href,title:"Quirks of JavaScript - The Language of the Web"}),e.jsx("p",{className:"introduction",children:"JavaScript is one of the most widely used programing languages in the world. It is the langauge that drives almost all the client side code on the internet. However, it has become a language which most people use but don't love. One of the main reasons behind this is that most people don't know the language well enough to appreciate its edge cases. In this article we will discuss some of these edge cases and try to understand why things are the way they are!"}),e.jsx("hr",{style:{backgroundColor:"white"}}),e.jsx("h3",{className:"headings",children:"The Abstract Equality Operator"}),e.jsx("p",{className:"montserrat",children:"JavaScript has two equality operators the Abstract Equality Operator '==' and Strict Equality Operator '==='. The abstract equality expressions are evaluated as per the abstract equality comparison algorithm. Let's look at some examples:"}),e.jsx("pre",{children:e.jsx("code",{children:`"2" == 2
