import{R as t,j as e,H as r,S as s}from"./index-B_R0noCP.js";import{P as a}from"./prism-B89pk0Pm.js";/* empty css              */class h extends t.Component{componentDidMount(){window.scrollTo(0,0),document.title="Quirks of JavaScript - The Language of the Web | blog by Pranshu Gupta",a.highlightAll()}render(){return e.jsxs("div",{className:"language-javascript",children:[e.jsx("div",{className:"row bhead",children:e.jsx(r,{className:"bigger gt1"})}),e.jsxs("h1",{className:"title",children:["Quirks of JavaScript - ",e.jsx("br",{}),"The Language of the Web"]}),e.jsxs("p",{children:["Pranshu Gupta, ",this.props.date]}),e.jsx(s,{link:window.location.href,title:"Quirks of JavaScript - The Language of the Web"}),e.jsx("p",{className:"introduction",children:"JavaScript is one of the most widely used programing languages in the world. It is the langauge that drives almost all the client side code on the internet. However, it has become a language which most people use but don't love. One of the main reasons behind this is that most people don't know the language well enough to appreciate its edge cases. In this article we will discuss some of these edge cases and try to understand why things are the way they are!"}),e.jsx("hr",{style:{backgroundColor:"white"}}),e.jsx("h3",{className:"headings",children:"The Abstract Equality Operator"}),e.jsx("p",{className:"montserrat",children:"JavaScript has two equality operators the Abstract Equality Operator '==' and Strict Equality Operator '==='. The abstract equality expressions are evaluated as per the abstract equality comparison algorithm. Let's look at some examples:"}),e.jsx("pre",{children:e.jsx("code",{children:`"2" == 2
...
console.log(myAdders[0](1))
console.log(myAdders[1](1))
console.log(myAdders[2](1))`})}),e.jsx("br",{}),e.jsx("br",{})]})}}export{h as default};
