                ...
                <div className="row-fluid" id="footerContent">
                    ...
                    <div className="col-sm-8" style={{ color: "white", textAlign: "center"}}>
                        <ul id="footerul">
                            ...
                            <a target="_blank" rel="noopener noreferrer" style={{color:"white"}} href="https://music.apple.com/profile/pranshug258"><i className="fab fa-apple socialIcon"></i></a>
                            <a target="_blank" rel="noopener noreferrer" style={{color:"white"}} href="https://open.spotify.com/user/31cr4nlq54iqlngkrrwdxff5faey?si=Q4d2S8utTEKMETey3_7uLw"><i className="fab fa-spotify socialIcon"></i></a>
                            ...
                            <a target="_blank" rel="noopener noreferrer" style={{color:"white"}} href="https://www.instagram.com/pranshug258/"><i className="fab fa-instagram socialIcon"></i></a>
                        </ul>
                        <small className="montserrat">© Copyright 2020, Pranshu Gupta</small><br></br>
