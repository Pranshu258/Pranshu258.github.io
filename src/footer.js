                ...
                <div className="row-fluid" id="footerContent">
                    ...
                    <div className="col-sm-8" style={{ color: "white", textAlign: "center"}}>
                        <ul id="footerul">
                            ...
                            <a target="_blank" rel="noopener noreferrer" style={{color:"white"}} href="https://open.spotify.com/playlist/3lciV1bfpnnGa2JzSfntGJ?si=5b549b8049a9413f"><i className="fab fa-spotify socialIcon"></i></a>
