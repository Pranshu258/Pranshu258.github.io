                ...
                <div className="row-fluid" id="footerContent">
                    ...
                    <div className="col-sm-8" style={{ color: "white", textAlign: "center"}}>
                        <ul id="footerul">
                            ...
                            <a target="_blank" rel="noopener noreferrer" style={{color:"white"}} href="https://open.spotify.com/user/pranshugupta?si=a6b20ba07e0944f4"><i className="fab fa-spotify socialIcon"></i></a>
