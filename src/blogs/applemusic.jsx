...
UTC Offset In Seconds`
                ...
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot7} />
                    <figcaption>Number of Tracks played per Month</figcaption>
                </figure>
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot8} />
                    <figcaption>Play Duration (hours) per Month</figcaption>
                </figure>
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot9} />
                ...
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot2} />
                ...
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot1} />
                ...
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot3} />
                ...
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot4} />
                ...
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot5} />
                    <figcaption>Track play frequency for top 30 artists</figcaption>
                </figure>
                <figure>
                    <img alt="" className="img-fluid blog-chart-img" src={plot6} />
