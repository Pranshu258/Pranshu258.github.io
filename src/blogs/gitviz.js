        ...
        return (
            <div className="language-python">
                ...
                <p>
                    ...
                    <button className="btn btn-warning"><a target="_blank" rel="noopener noreferrer" style={{ color: "black", textDecoration: "none" }} href="https://colab.research.google.com/drive/1bFCQI_0Gm5MpLGg0s1uKGF5fmu5EUrMJ?usp=sharing"><b style={{ padding: "0 10px 0 0px" }}>Open in Google Colab</b><i class="fas fa-external-link-alt"></i></a></button>
                </p>
                <hr style={{ backgroundColor: "white" }}></hr>
                <h2 className="headings">GitHub Data Mining</h2>
                <p>
                    We can use the GitHub rest API to collect data for commits, forks, issues and pull requests. The API returns JSON objects which have all the information we need. In order to use the GitHub API, we have to create a personal access token (which is free), which can be done on the github developer settings section on the settings page of our account. We may use the GitHub API without creating this token, but data collection will be slow because of rate limiting.
                </p>
                <div> 
                ...
                <p>
                    Angular is a front end framework well known for builing rich single page applications. It was developed by Google using TypeScript, a language developed by Microsoft, that is a superset of JavaScript. Before Angular, we had AngularJS which will reach end of support in 2021. In this post we will exclusively talk about Angular and not AngularJS. 
                </p>
                <p>
                ...
                <p>
                    ...
                    <br></br>
                    In the plot below, we look at the total commits pushed to Angular and React each month since they were publihsed on GitHub. We can see that Angular usually has higher number of commits per month as compared to React. If we look at the number of commits per contributor per month, we can see that it still a little bit higher for Angular. However, React developers seem to be closing the gap in 2020.
                </p>
                ...
                <p>Developers add a message describing the changes associated with the commit, so that it is easier for others to review the changes in future. We can see that commit messages posted by Angular developers have become much more descriptive as compared to the ones posted by React developers over the past year. However, the opposite was true before that</p>
                <div style={{ height: "250px", width: "900px" }}>
                    <LineChart 
                ...
                <p>
                    In the following plots, we look at the number of new issues created on the repositories each month. We can see that the number of issues submitted on Angular are much higher as compared to React. This could be due to the larger codebase of Angular, or it could be indicative of Angular's usage in larger enterprise level projects, where issue resolution is considered more critical as compared to smaller projects.
                </p>
                <div style={{ height: "250px", width: "900px" }}>
                    <LineChart 
                ...
                <p>
                    It is important that the issues submitted on the repositories are worked on and fixed as quickly as possible. We can see in the plot below, that both Angular and React have been equally fast at resolving the issues and maintaining a healthy project in the recent years. 
                </p>
                <div style={{ height: "250px", width: "900px" }}>
                    <LineChart 
                ...
                <p>
                    GitHub is a great platform for building open source software with a plethora of features for softwrae development. There are many repositories other than Angular and React which are as valued in the open source community and enterprise as well. 
                </p>
                <p>
                    Wouldn't it be great if GitHub showed all of these insights out of the box? Until then, if you are interested, feel free to look at the jupyter notebook on Google Colab and you will be able to do all the above analysis by yourself. 
                </p>
                <p>
                    Thank You 😀❤
                </p>
