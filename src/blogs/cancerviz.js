            ...
            <div>
                ...
                <p>
                    ...
                    <ol>
                        ...
                        <li>
                        Melanoma has become more common in recent years, and is the leading cause of skin cancer deaths. <b>Increased exposure to UV radiation due to ozone depletion, tanning beds, and changing climate patterns are among some of the factors that led to its rise.</b> Light skinned population is at a higher risk, because of lower melanin levels in the skin (Melanin is a pigment that protects the skin from UV radiation). Some genetic factors also play a role, mutations in the genes such as BRAF, CDKN2A, MC1R and CDK4, can lead to uncontrolled cell growth and division, which can result in melanoma. 
                        </li>
                    </ol>
                </p>
