                ...
                <ol className="renju-training-protocol" aria-label="Renju neural-network training stages">
                    {[
                        ...
                        },
                        {
                            ...
                            result: 'After 550 update steps, the model reached a 57% overall game win rate against minimax. Golden-set position accuracy stayed flat (11–15% on Black positions, 13–20% on White positions), confirming the RL phase improved game-level strategy rather than individual move precision. White positions actually showed higher peak accuracy than Black during this phase — the color asymmetry only emerged in head-to-head game win rates, where Black\'s first-move advantage gave it an easier path to curriculum progression.',
                        },
                        {
                            stage: 'Stage 3',
                        ...
                        },
                        {
                            ...
                            result: 'Human FT had mixed effects on golden-set accuracy. For Black, accuracy was flat (~16.3%, essentially unchanged from the specialist terminal). For White, it settled at ~18% — below the White Specialist\'s peak of ~22% but above its noisy terminal checkpoint (~17%). The fine-tuning added strategic variety from human play at the cost of some of the tactical sharpness built during specialist training.',
                        },
                        {
                            stage: 'Stage 5',
                            ...
                            result: 'Tactical constraint training produced the largest single improvement in golden-set accuracy: the Black model jumped from ~16% (human FT) to ~23%, and the White model from ~18% (human FT) to ~27%, eliminating the major missed-four/block failure mode. The mixed-color Elo tournament results (below) give the most complete picture of relative strength across all models.',
                        },
                        {
                            stage: 'Stage 6',
