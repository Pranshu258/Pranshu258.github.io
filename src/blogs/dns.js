    ...
    render() {
        return (
            <div>
                ...
                <h2 className="headings">Architecture</h2>
                ...
                <h2 className="headings">Name Space</h2>
                ...
                <h2 className="headings">Resource Records</h2>
                ...
                <hr style={{ backgroundColor: "white" }}></hr>
                <h2 className="headings">DNS Database Distribution</h2>
                ...
                <h3 className="headings">DNS Zones</h3>
                ...
                <h3 className="headings">DNS Cache</h3>
                ...
                <hr style={{ backgroundColor: "white" }}></hr>
                <h2 className="headings">DNS Communication Protocol</h2>
                ...
                <h2 className="headings">DNS in Virtual Networks</h2>
                ...
                <h2 className="headings">DNS in Dual Stack Networks</h2>
                <blockquote>
                ...
                <br></br><br></br><br></br>
                <hr style={{ backgroundColor: "white" }}></hr>
                <h2 className="headings">Security for DNS</h2>
                ...
                <h3 className="headings">DNS over TLS (DoT)</h3>
                ...
                <h3 className="headings">DNS over HTTPS (DoH)</h3>
                ...
                <h3 className="headings">DNS Cache Poisoning</h3>
                ...
                <h3 className="headings">DNS Secure Portocol (DNSSEC)</h3>
